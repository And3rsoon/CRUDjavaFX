...
public class cadTelClienteRepository {
	...
	//metodo testado ok
	public String gavar(telefonesClientes categoria) {
	...
	public String update(telefonesClientes categoria) {
	    EntityManager etm = this.getEM();
	    try {
	        etm.getTransaction().begin();
	...
	//metodo testado ok
	public String deletar(telefonesClientes categoria) {
	    ...
	    try {
	        ...
	        if (entityManager.contains(categoria)) {
	        	...
	        	telefonesClientes mesaGerenciado = entityManager.merge(categoria);
	...
	//metodo ok
	public List<telefonesClientes> ListarTodos() {
	    EntityManager entityManager = this.getEM();
	    try {
	        List<telefonesClientes> query = entityManager.createQuery("SELECT p FROM telefonesClientes p", telefonesClientes.class).getResultList();
	        return query;
	    } catch (Exception e) {
	        e.printStackTrace();
	        return null;
