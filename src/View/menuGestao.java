...
public class menuGestao extends Application {
    ...
    public void start(Stage stage) {
        ...
        // Botões
        Button btnCompra = new Button("Cadastro Funcionario");
        ...
        // Layout central
        VBox vbox = new VBox(20, btnCompra,btnVoltar);
        ...
        btnCompra.setOnAction((EventHandler<ActionEvent>) new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                	 ...
                	 CadastroFuncionario et=new CadastroFuncionario();
                	 et.start(new Stage());
