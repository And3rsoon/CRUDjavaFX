...
public class MenuClienteView extends Application{
    ...
    public void start(Stage stage) {
        ...
        // Botões
        Button btnEstoque = new Button("Adicionar");
     ...
     // Botões
        ...
        // Layout central
        VBox vbox = new VBox(20, btnEstoque,btnGerenciar,btnVoltar);
        ...
        btnGerenciar.setOnAction((EventHandler<ActionEvent>) new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
            		...
            		ClientesGerView et=new ClientesGerView();
                	 et.start(new Stage());
        ...
        btnEstoque.setOnAction((EventHandler<ActionEvent>) new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                	 ...
                	 CadastroClientes et=new CadastroClientes();
                	 et.start(new Stage());
